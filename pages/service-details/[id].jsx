...
const serviceDetails = [
    {
        id: 1,
        title: "Web Design",
        subTitle: "Special Solutions For Web Development",
        ...
        imageText: "Web Solutions Research and Idea Generate",
        image: "../assets/images/about/service-page-about.jpg",
...
const ServiceDetails = () => {
  ...
  return (
    <Layout footer={1} dark={dark} singleMenu={singleMenu} hideHeader={true} hideFooter={true}>
              ...
              <div className="about-content wow fadeInUp delay-0-4s">
                ...
                <div className="content">
                  ...
                  <ul className="list-style-three pt-15 pb-25">
                    {service?.accordionData.map((data, i) => (
